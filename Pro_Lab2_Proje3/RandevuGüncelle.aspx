<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RandevuGüncelle.aspx.cs" Inherits="Pro_Lab2_Proje3.RandevuGüncelle" %>
...
<body>
    <form id="form1" runat="server" class="auto-style1">
        <div class="auto-style3">
            ...
            <strong>Randevu Güncelle</strong></div>
        <div>
    ...
    <asp:TextBox ID="txtTarih" runat="server" type="date" ></asp:TextBox>
        ...
        <div class="form-group">
            <asp:Button ID="btnRandevuGuncelle" runat="server" Text="Randevu Güncelle" OnClick="btnRandevuGuncelle_Click" CssClass="auto-style2" Width="462px" />
        </div>
    </form>
</body>
</html>
