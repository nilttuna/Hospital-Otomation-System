<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Raporlar.aspx.cs" Inherits="Pro_Lab2_Proje3.Randevular" %>
        ...
        <div class="upload-container">
            ...
            <div class="upload-form">
                <div class="form-group">
                    ...
                    <asp:Label ID="lblFileName" runat="server" CssClass="custom-file-label" AssociatedControlID="fileUpload" Text="Dosya Seçin"></asp:Label>
                </div>
                <div class="form-group">
                    <asp:Label ID="lblDoktor" runat="server" Text="Doktor İsimleri:"></asp:Label>
                    <asp:DropDownList ID="ddlDoktorlar" runat="server" CssClass="form-control">
