...
namespace Pro_Lab2_Proje3
{
    public partial class HastaEkle : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Hatalı TC'); window.location = 'YoneticiSayfası.aspx';", true);
                return;
            }
            ...
            {
                ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Ekleme Başarısız'); window.location = 'HastaEkle.aspx';", true);
            }
