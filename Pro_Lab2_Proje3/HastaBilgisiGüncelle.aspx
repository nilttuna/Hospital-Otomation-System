<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HastaBilgisiGüncelle.aspx.cs" Inherits="Pro_Lab2_Proje3.HastaBilgisiGüncelle" %>
...
<head runat="server">
    ...
    <title>Hasta Bilgisi Güncelle</title>
    ...
    <div class="kenarlikli-div">
        <form id="form1" runat="server">
            <div style="width: 449px; text-align: left;">
                ...
                <asp:TextBox ID="TextBox1" runat="server" style="margin-left: 62px" Width="181px" Enabled="False"></asp:TextBox>
            </div>
            <div>&nbsp;</div>
            ...
            <div>
                ...
                <asp:TextBox ID="TextBox6" runat="server" style="margin-left: 26px" Width="309px"></asp:TextBox>
            </div>
            <div>&nbsp;</div>
            <div style="text-align: left">
                <asp:Button ID="Button1" runat="server" Text="Bilgilerimi Güncelle" Width="464px" Height="34px" BackColor="Black" CssClass="button2" ForeColor="White" OnClick="Button1_Click" />
            </div>
        </form>
    </div>
            </td>
